...
export default async function WorkoutPage() {
  const res = await fetch(
    "http://localhost:3000/api/products?category=workout",
    {
      cache: "no-store",
    },
  );
  ...
  const upsellOffer =
    upsell && dbProduct?.upsellPrice != null
      ? {
  ...
  const product: ProductData = {
    _id: dbProduct ? String(dbProduct._id) : "default-workout-id",
    slug: "workout",
    ...
    originalPrice: 47,
    image:
      dbProduct?.image ?? "/ebooks-cover/reset-your-body-workout-guide.png",
    upsellOffer,
    headline:
    ...
    whatYouGet: [
      ...
      {
        title:
          'Pain-Specific Quick Fix Routines (Your "When This Hurts" Toolkit)',
        description:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Many people notice changes in the first 1–2 weeks. Bigger changes come from finishing the full 4 weeks and then maintaining.",
      },
      {
        q: "What if I'm dealing with real pain or an injury?",
        a: "This is not medical advice. If you have a serious injury, talk to a qualified professional first.",
      },
    ],
    reviews: [
      {
        name: "Mark R.",
        stars: 5,
        text: "First week in and my back pain is already 70% gone. This is the real deal.",
      },
      {
        name: "Sarah T.",
        stars: 5,
        text: "Finally a program that actually fits into my day. 15 minutes and I feel incredible.",
      },
      {
        name: "James W.",
        stars: 5,
        text: "I'm 52 and I feel better than I did at 40. Wish I found this sooner.",
      },
      {
        name: "Linda K.",
        stars: 5,
        text: "The visuals make it so easy to follow. No confusion, just results.",
      },
      {
        name: "David M.",
        stars: 5,
        text: "Bought this for my dad. He's moving better than he has in years.",
      },
      {
        name: "Amy S.",
        stars: 5,
        text: "Week 2 update — knees feel amazing. The quick fix routines are gold.",
      },
    ],
    recommended: {
      slug: "nutrition",
